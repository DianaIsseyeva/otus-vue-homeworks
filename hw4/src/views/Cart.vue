<template>
  <div class="cart-container">
    ...
    <div v-if="cartState.items.length > 0" class="cart-content">
      ...
      <div class="cart-actions">
        <button @click="removeAllFromCart" class="clear-button">Очистить корзину</button>
...
const { cartState, removeFromCart, removeAllFromCart, totalQuantity, totalPrice } = useCart();
